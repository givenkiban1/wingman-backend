...
def save_model(model: RandomForestClassifier) -> None:
    ...
    if not os.path.exists(Path(LOCAL_REGISTRY_PATH).joinpath("models")):
        # Create the directory
        os.makedirs(Path(LOCAL_REGISTRY_PATH).joinpath("models"))
...
def load_model(stage="Production") -> RandomForestClassifier:
    """
